...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-between sticky-navbar">
        <a class="navbar-brand ms-3" href="#">Fashion-Hive</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <form action="search.php" method='post' class="d-flex mx-3">
                    <input class="form-control mr-sm-2 me-3" type="search" name="search_query" placeholder="Search" aria-label="Search" autocomplete="off">
