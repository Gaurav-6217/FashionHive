<?php
include "menu.php";
include "/xampp/htdocs/fashionhive/shared/connection.php";

$sql_obj = mysqli_query($conn, "select * from product where sub_category = '$product_type'");
    ...
    echo "<div class='row' style='margin-top: 70px;'>";
        while ($row = mysqli_fetch_assoc($sql_obj)) {
            ...
            echo "<div class='card mb-2 mt-2' style='max-width: 18rem;'>
                <img class='card-img-top' src='$img_path' alt='$row[name]' style='height: 13rem'>
                <div class='card-body'>
